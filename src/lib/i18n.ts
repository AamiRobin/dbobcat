...
export const en = {
  ...
  // ER diagram (React Flow / Supabase-style visualizer)
  ...
  "er.toolbar.copySql": "Copy as SQL",
  "er.toolbar.refresh": "Refresh diagram",
  "er.toolbar.search": "Find table or column…",
  "er.toolbar.searchClear": "Clear search",
  "er.legend.title": "Legend",
  "er.legend.pk": "Primary key",
  "er.legend.fk": "Foreign key",
  "er.legend.unique": "Unique",
  "er.legend.identity": "Auto-increment",
  "er.legend.nullable": "Nullable",
  ...
  "er.toast.copiedSql": "Schema SQL copied to clipboard",
  "er.toast.copySqlEmpty": "No columns loaded to copy",
  ...
  "ai.bar.title": "AI",
  "ai.bar.placeholder": "Describe the query you need…",
  "ai.bar.run": "Ask AI",
  "ai.bar.stop": "Stop",
  "ai.bar.fix": "Fix with AI",
  "ai.bar.explain": "Explain with AI",
  "ai.bar.insert": "Insert",
  "ai.bar.replace": "Replace editor",
  "ai.bar.copy": "Copy",
  "ai.bar.discard": "Discard",
  "ai.bar.retry": "Retry",
  "ai.bar.thinking": "Thinking…",
  "ai.bar.privacy": "Shares schema & SQL only — never your row data.",
  "ai.bar.disabled": "AI assistant is off.",
  "ai.bar.setup": "Set up AI",
  "ai.bar.needConnection": "Connect to a server to use the AI assistant.",
  "ai.settings.title": "AI Assistant",
  "ai.settings.description":
    "Bring your own key. Requests go straight from this app to the provider you choose — DBobcat has no server in between.",
  "ai.settings.enable": "Enable AI assistant",
  "ai.settings.presets": "Provider presets",
  "ai.settings.baseUrl": "API base URL",
  "ai.settings.model": "Model",
  "ai.settings.modelPlaceholder": "e.g. gpt-4o-mini, claude-sonnet-4-5, llama3.2",
  "ai.settings.apiKey": "API key",
  "ai.settings.apiKeyPlaceholder": "Paste your key…",
  "ai.settings.saveKey": "Save key",
  "ai.settings.removeKey": "Remove key",
  "ai.settings.keyStored": "Key stored {hint}",
  "ai.settings.test": "Test connection",
  "ai.settings.testing": "Testing…",
  "ai.settings.testOk": "Provider replied: {reply}",
  "ai.settings.saveFirst": "Save a key first, then test.",
  "ai.settings.privacyNote":
    "What is sent: table/column names, types, keys, and your SQL. What is never sent: your data rows. Using a local endpoint (Ollama, LM Studio) keeps everything on this machine.",
  "ai.settings.preset.openai": "OpenAI",
  "ai.settings.preset.openrouter": "OpenRouter",
  "ai.settings.preset.ollama": "Ollama (local)",
  "ai.settings.preset.lmstudio": "LM Studio (local)",
  "ai.mcp.title": "Agent access (MCP)",
  "ai.mcp.enable": "Expose DBobcat to AI agents (MCP)",
  "ai.mcp.description":
    "Lets MCP clients (Claude Code, Cursor, …) run `dbobcat mcp` and query the connections you allow. Read-only: writes, DDL and multi-statement scripts are always rejected.",
  "ai.mcp.loading": "Loading connections…",
